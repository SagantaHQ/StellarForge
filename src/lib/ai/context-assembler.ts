...
// Re-export diff parsing from the dedicated ai-diff-parser module
export { extractAndParseDiffs as parseDiffFromResponse, applyDiffToContent as applyParsedDiff } from "./ai-diff-parser";
export type { AIDiff as ParsedDiff } from "./ai-diff-parser";
